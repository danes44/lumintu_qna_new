...
<body>
    <div class="container-lg px-0 px-sm-0 px-md-4 py-md-4 pt-lg-4 pt-xl-4 pt-xxl-4">
        <div class="card border-0 shadow-lg navbar-expand-lg" style="border-radius: .75rem 0 0 .75rem; width: 100%;height: 100%;">
            <div id="card-content-full" class="row g-0">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 collapse navbar-collapse" id="navbarSupportedContent">
                    <img src="assets/bg-group2.png" class="" alt="..." height="560px" style="border-radius: .75rem 0 0 .75rem;object-fit: fill;">
                    <div class="card-img-overlay p-0 text-white px-5 pt-4" id="card-info" >
                ...
                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
                    <div class="card border-0 rounded-0">
                        ...
                        <div id="conversation-footer" class="border-0 px-3 py-3 fixed-sm-bottom" style="border-radius: 0 0 .75rem 0; background-color: #FFFFFF;">
                            <!-- conversation -->
    ...
    <script>
      moment.locale('id'); //set timezne to Indonesia
